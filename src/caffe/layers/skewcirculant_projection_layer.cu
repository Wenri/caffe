...
template <typename Dtype>
void SkewcirculantProjectionLayer<Dtype>::Forward_gpu(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void SkewcirculantProjectionLayer<Dtype>::Backward_gpu(const vector<Blob<Dtype>*>& top,
...
INSTANTIATE_LAYER_GPU_FUNCS(SkewcirculantProjectionLayer);
